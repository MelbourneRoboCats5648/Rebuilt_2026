...
frc2::CommandPtr ChoreoShootTrench(DriveSubsystem* drive, IntakeSubsystem* intake, ShooterSubsystem* shooter);

frc2::CommandPtr ChoreoShootFromLeft(DriveSubsystem* drive, IntakeSubsystem* intake, ShooterSubsystem* shooter);

frc2::CommandPtr ChoreoShootFromRight(DriveSubsystem* drive, IntakeSubsystem* intake, ShooterSubsystem* shooter);

frc2::CommandPtr ChoreoShootFromMiddle(DriveSubsystem* drive, IntakeSubsystem* intake, ShooterSubsystem* shooter);
...
frc2::CommandPtr MRTPlayoff(DriveSubsystem* drive);
}  // namespace autos
